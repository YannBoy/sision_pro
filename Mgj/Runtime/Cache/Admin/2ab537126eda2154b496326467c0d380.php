    ...
    <div class="main-content">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo U('Grow/index');?>">成长档案</a>
                </li>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div>
                        <div class="model-ul" >
                            <ul>
                                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li id="<?php echo ($info["id"]); ?>" class="getGrowinfos"><?php echo ($info["title"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                        </div>
