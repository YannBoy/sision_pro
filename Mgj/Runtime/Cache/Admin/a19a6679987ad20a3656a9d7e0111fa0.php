                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/index.php/User/insert_teacher" method="post">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        <tbody>
                                        <tr>
                                            <td style="text-align:right;">手机号码：</td>
                                            <td><input type="text" name="tea_mobile" id="form-field-1" class="col-xs-10 col-sm-2" />
                                                <div id="tips" style="line-height:30px;padding-left: 220px;color:red;display:none;">手机号码格式错误或不存在</div></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;">真实姓名：</td>
                                            <td><input type="text" name="tea_name" id="form-field" class="col-xs-10 col-sm-1" /></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select name="school_num" id="num_id4">
                                                    <option value="">-选-择-学-校-</option>
                                                </select>
                                                <select name="class_num" id="num_id5">
                                                    <option value="">-选-择-班-级-</option>
                                                </select>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><select name="grade">
                                                <?php if(is_array($course)): $i = 0; $__LIST__ = $course;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["name"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select></td>
                                        </tr>
                                        <!--<tr>-->
                                            <!--<td style="text-align:right;">职称：</td>-->
                                            <!--<td><input type="text" name="tea_jobbh" id="form-field-3" class="col-xs-10 col-sm-1" /></td>-->
                                        <!--</tr>-->
                                        <!--<tr>-->
                                            <!--<td style="text-align:right;">所在部门：</td>-->
                                            <!--<td><input type="text" name="tea_deptbh" id="form-field-3" class="col-xs-10 col-sm-1" /></td>-->
                                        <!--</tr>-->
                                        <tr>
                                            <td style="text-align:right;"><input type="submit" class="btn no-border" value="注册" id="add_user" style="display:none"></td>
                                            <td>
                                                <a href="<?php echo U('User/addteacher');?>"><button type="button" class="btn btn-primary">重置</button></a>
                                                <a href='teacher'><div class="btn no-border">返回上一页</div></a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
