...
<html lang="en">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-responsive">
								<form action="/index.php/Group/update" method="post" enctype="multipart/form-data">
									...
									<tbody>
										...
										<tr>
											...
											<?php if(is_array($rules)): foreach($rules as $key=>$v): ?><div style="width:200px;height:30px;line-height:30px;float:left">
												<input type="checkbox" style="margin-top:8px;width:24px" name="rules[]"  id="form-field-1" value="<?php echo ($v['id']); ?>" placeholder="规则 (控制器名/方法名)" class="col-xs-10 col-sm-5 true_c" <?php if(in_array($v['id'],$data)): ?>checked<?php endif; ?>/><?php echo ($v['title']); ?>
										...
										<tr>
											...
											<td>
												...
												<button type="button" class="btn btn-primary all_chose">全选</button>
												<button type="button" class="btn btn-danger no_chose">全不选</button>
											</td>
										</tr>
									</tbody>
								</table>
	...
	<script>
		$('.all_chose').click(function(){
			$('.true_c').attr('checked',true);
		})
		$('.no_chose').click(function(){
			$('.true_c').attr('checked',false);
		})
