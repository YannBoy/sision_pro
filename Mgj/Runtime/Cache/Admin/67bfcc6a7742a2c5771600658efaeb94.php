    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <div class="nav-search" id="nav-search">
                <form class="form-search" action="<?php echo U('Admin/School/index');?>" method="get">
                    <span>
                        <label>
                                ...
                                <form action="" method="post">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
                                        ...
                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                <th class="center"><?php echo ($vo["ocode_name"]); ?></th>
                                                <th class="center"><?php echo ($vo["area_bh"]); ?>-<?php echo ($vo["ocode"]); ?></th>
                                                <td>
                                                    <div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                        <!-- 学校包含班级弹框  -->
                                                        <a href="<?php echo U('find_class',array('area_bh'=>$vo['area_bh'],'ocode'=>$vo['ocode']));?>"><button type="button" class="btn btn-primary btn-xs">查看班级</button></a>
                                                        <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target=".bs-example-modal-2g" id="<?php echo ($vo["rec_id"]); ?>" name="school_rec_id">修改</button>
                                                        <button type="button" class="btn btn-warning btn-xs" id="<?php echo ($vo["rec_id"]); ?>"  name="school_del_id">删除</button>
                                                    </div>
