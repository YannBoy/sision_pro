...
<html lang="en">
    ...
    <div class="main-content">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">校内通知</li>
            </ul><!-- .breadcrumb -->

            <div class="nav-search" id="nav-search">
                <form class="form-search" action="<?php echo U('Admin/Office/notice');?>" method="get">
                    <span>
                        <label>
        ...
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <a href="<?php echo U('Office/make_notice');?>"> <button class="btn btn-primary btn-xs" style="margin-bottom:5px;">管理</button> </a>
                    <!-- <a href="<?php echo U('Office/notice_all');?>"> <button class="btn btn-primary btn-xs" style="margin-bottom:5px;">浏览全部</button> </a> -->

                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/index.php/Office/delete" method="post">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
                                        <thead>
                                        <tr>
                                            <th class="center col-lg-6">标题</th>
                                            <th class="center">发布者</th>
                                            <th class="center">发布日期</th>
                                            <th class="center">阅读</th>
                                        ...
                                        <?php if(is_array($notice)): $i = 0; $__LIST__ = $notice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$notice): $mod = ($i % 2 );++$i;?><tr>
                                                <td data-toggle="modal" data-target=".bs-example-modal-sm1" id="<?php echo ($notice["id"]); ?>" class="get_notice_id"><?php echo ($notice["title"]); ?></td>
                                                <td class="center"><?php echo ($notice["relname"]); ?></td>
                                                <td class="center"><?php echo ($notice["do_time"]); ?></td>
                                                <td class="center"><?php echo ($notice["allnum"]); ?></td>
                                                <td class="center">
                                                <?php if($notice['do_state'] == 0 ): ?><p style="color:green">已查看</p>
                                                    <?php elseif($notice['do_state'] == 1): ?> <p style="color:red">未查看</p><?php endif; ?>
                                    ...
                                    <input type="button" class="btn btn-primary btn-xs"  value="发布通知" name="notice">
                                </form>
    ...
    <input type="hidden" class="public" value='/Public'/>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"> 新通知</h4>
                </div>
                <div style="padding: 25px;width:550px">
                名称: <input type="text" class="form-control" name="notice_name"/>
                </div>
                <div style="padding: 10px;margin-left:480px">
                <button class="btn btn-primary btn-sm" name="notice">确定</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade bs-example-modal-sm1" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
        <div class="modal-dialog modal-sm" style="width:820px;height:650px;">
            <div class="modal-content" style="height:680px;">
                ...
                <div style="padding-left:20px;padding-right:20px;padding-bottom:20px;">
                    <h5 class="center" id="title_get"></h5>
                    <hr/>
                    <div class="content_get" style="width:760px;height:420px;overflow:scroll;"></div>

                    <div style="width:700px;height:60px;border:1px solid #2b7dbc;margin:20px;padding: 10px;">
                        附件: <br/>
                        <div class="file_get" style="margin-left:30px;">
