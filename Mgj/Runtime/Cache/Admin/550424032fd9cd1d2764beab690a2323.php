                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/index.php/User/update_teacher" method="post" enctype="multipart/form-data">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        <tbody>
                                        <tr>
                                            <td style="text-align:right;">手机号码：</td>
                                            <td>
                                                <input type="hidden" name="id" value="<?php echo ($list["rec_id"]); ?>" />
                                                <?php echo ($list["tea_mobile"]); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;">真实姓名：</td>
                                            <td><input type="text" name="tea_name" id="form-field" class="col-xs-10 col-sm-1" value="<?php echo ($list["tea_name"]); ?>"/></td>
                                        </tr>
                                            ...
                                            <td>
                                                <select name="num1" id="num_id">
                                                    ...
                                                    <option value="<?php echo ($num["1"]["area_bh"]); ?>">
                                                        <?php
 if($num['1']['area_bh']){ echo $num['1']['area_name']; } else { echo '请选择'; } ?>
                                                    </option>
 ...
 if($num['5']['class_name']){ echo $num['5']['class_name']; } else { echo '-选-择-班-级-'; } ?></option>
                                        ...
                                        <tr>
                                            ...
                                            <td><select name="grade">
                                                <option value="<?php echo ($num["6"]["tea_coursebh"]); ?>">
                                                    <?php
 if($num['6']['tea_coursebh']){ echo $num['6']['tea_coursebh']; } else { echo '请选择'; } ?></option>
                                                </option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href='<?php echo U('User/teacher');?>'><div class="btn no-border">返回上一页</div></a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
