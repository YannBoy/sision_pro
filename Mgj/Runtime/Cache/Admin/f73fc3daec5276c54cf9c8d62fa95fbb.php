                            ...
                            <div class="table-responsive">
                                ...
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
                                    ...
                                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <a href="<?php echo U('Office/teacher_info',array('id'=>$vo['id']));?>"><button>查看组内成员</button></a>
                                                <button data-toggle="modal" data-target=".bs-example-modal-lg" name="get_sch_info" id="<?php echo ($vo["id"]); ?>">修改名称</button>
                                                <button name="group_del" id="<?php echo ($vo["id"]); ?>">删除</button>
                                            </td>
                                ...
                                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target=".bs-example-modal-sm">添加二级分组</button>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content" style="padding:25px">
                ...
                <div class="form-group">
                    <label>分组名称</label>
                    <input type="text" class="form-control" id="name" placeholder="分组名称">
                    <input type="hidden" id="url" value="<?php echo $_SERVER['HTTP_HOST'] ?>"/>
                </div>
                <button type="button" class="btn btn-primary btn-xs" name="sch_group_add">保存</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="padding:25px">
                ...
                <button type="button" class="btn btn-primary btn-xs" name="sch_group_edit">修改</button>
            </div>
        </div>
    </div>
