                            ...
                            <div class="table-responsive">
                                    ...
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
                                        ...
                                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo U('Office/group_two',array('id'=>$vo['id']));?>"><button class="btn btn-info btn-xs">查看二级分组</button></a>
                                                    <button class="btn btn-danger btn-xs" data-toggle="modal" data-target=".bs-example-modal-lg" name="get_sch_info" id="<?php echo ($vo["id"]); ?>">修改名称</button>
                                                    <button class="btn btn-warning btn-xs" name="group_del" id="<?php echo ($vo["id"]); ?>">删除</button>
                                                </td>
                                ...
                                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target=".bs-example-modal-sm">添加部门</button>
