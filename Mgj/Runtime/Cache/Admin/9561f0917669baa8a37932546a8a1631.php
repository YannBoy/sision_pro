                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="" id="nav-search" style="margin-bottom: 10px">
                                <form class="form-search" action="<?php echo U('Visitor/leavel');?>" method="get">
                                ...
                                <form action="" method="post">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
                                        ...
                                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
                                                <td class="center"><?php echo ($info["vs_ocodename"]); ?></td>
                                                <td class="center"><?php echo ($info["vs_username"]); ?></td>
                                                <td class="center"><?php echo ($info["vs_classname"]); ?></td>
                                                <td class="center"><?php echo ($info["vs_tel"]); ?></td>
                                                <td class=""><?php echo ($info["event_context"]); ?></td>
                                                <td class="center"><?php echo ($info["pass_type"]); ?></td>
                                                <td class="center"><?php echo ($info["oper_id"]); ?></td>
                                                <td class="center"><?php echo ($info["begintime"]); ?></td>
                                                <td class="center"><?php echo ($info["endtime"]); ?></td>
                                                <td class="center"><?php echo ($info["state"]); ?></td>
                                                <td class="center"><?php echo ($info["passflag"]); ?></td>
                                                <td class="center"><button type="button" class="btn btn-warning btn-xs delete_visitor" ab="visitstudentevent" rec_id="<?php echo ($info["rec_id"]); ?>">删除</button></td>
                                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                        <tr>
                                            <td colspan="13" id="pages"><div class="row"><div class="col-md-5"></div><?php echo ($page); ?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </form>
                                <a href="<?php echo U('Visitor/addleavel');?>">添加</a>
