                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="" id="nav-search" style="margin-bottom: 10px">
                                <form class="form-search" action="<?php echo U('Visitor/curevent');?>" method="get">
                                ...
                                <form action="" method="post">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
                                        ...
                                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td class="center"><?php echo ($info["link"]); ?></td>
                                                ...
                                                <td class="center"><button type="button" class="btn btn-warning btn-xs delete_visitor" ab="visitnotice" rec_id="<?php echo ($info["rec_id"]); ?>">删除</button></td>
