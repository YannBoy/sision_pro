                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/index.php/User/user_update" method="post" enctype="multipart/form-data">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" name="relname" value="<?php echo ($list["relname"]); ?>"/>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="text-align:right;">权限区：</td>
                                            <td>
                                                目前权限区域:
                                                <div>
                                                <?php if(is_array($exist)): $i = 0; $__LIST__ = $exist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="button" value="<?php echo ($vo["class_name"]); ?>" class="btn btn-info btn-xs" name="but_quanxian" id="<?php echo ($vo["rec_id"]); ?>"/>&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
                                                </div>
                                                <br/><br/><br/>
                                                新添加区域:
                                                <select name="num1" id="num_id">

                                                    <option value="<?php echo ($area_name["area1"]["area_bh"]); ?>">
                                                        <?php echo ($area_name["area1"]["area_name"]); ?>
                                                    </option>
                                                ...
                                                <select name="num2" id="num_id2">
                                                    <option value="<?php echo ($area_name["area2"]["area_bh"]); ?>">
                                                        <?php echo ($area_name["area2"]["area_name"]); ?>
                                                    </option>
                                                </select>
                                                <select name="num3" id="num">
                                                    <option value="<?php echo ($area_name["area3"]["area_bh"]); ?>">
                                                        <?php echo ($area_name["area3"]["area_name"]); ?>
                                                    </option>
                                                </select>
                                                <select name="school_num" id="num_id4">
                                                    <option value="<?php echo ($school_name["ocode"]); ?>">
                                                        <?php echo ($school_name["ocode_name"]); ?>
                                                    </option>
                                                </select>
                                                <select name="class_num" id="num_id5">
                                                    <option value="">-请-选-择-班-级-</option>
                                                    <?php if(is_array($class_name)): $i = 0; $__LIST__ = $class_name;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$class_name): $mod = ($i % 2 );++$i;?><option value="<?php echo ($class_name["class_bh"]); ?>"><?php echo ($class_name["class_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                                <input type="button" id="user_add_quanxian" class="btn btn-success btn-xs" value="添加"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><select name="group_id">
                                                <option value="<?php echo ($group["id"]); ?>">
                                                    <?php
 if($group['title']){ echo $group['title']; } else { echo '普通组'; } ?></option>
                                                <?php if(is_array($group_list)): $i = 0; $__LIST__ = $group_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href='<?php echo U(group_user);?>'><div class="btn no-border">返回上一页</div></a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
