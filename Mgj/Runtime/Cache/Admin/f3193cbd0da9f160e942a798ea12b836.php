	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="row">
					<div class="col-xs-12">
						<a href="<?php echo U('Group/add');?>"><button class="btn btn-info btn-xs pull-right">部门添加</button></a>
									...
									<?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
										...
										<td>
											<div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">
												...
												<a href="/index.php/Group/edit/id/<?php echo ($v["id"]); ?>.html" class="btn btn-xs btn-info">
													<i class="icon-edit bigger-120"></i>
												</a>

												<a href="/index.php/Group/delete/id/<?php echo ($v["id"]); ?>.html" class="btn btn-xs btn-danger">
