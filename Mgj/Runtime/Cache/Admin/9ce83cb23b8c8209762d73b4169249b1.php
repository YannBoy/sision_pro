					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-responsive">
								<form action="/index.php/Rule/delete" method="post">
										...
										<?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
											...
											<td>
												<div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">
													...
													<a href="/index.php/Rule/edit/id/<?php echo ($v["id"]); ?>.html" class="btn btn-xs btn-info">
														<i class="icon-edit bigger-120"></i>
													</a>

													<a href="/index.php/Rule/delete/id/<?php echo ($v["id"]); ?>.html" class="btn btn-xs btn-danger">
