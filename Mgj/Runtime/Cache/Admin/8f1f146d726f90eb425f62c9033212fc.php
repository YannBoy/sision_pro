                    ...
                    <div style="padding: 10px">
                        <table class="table">
                            ...
                            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
                                    <td class="center"><?php echo ($info["title"]); ?></td>
                                    <td class="center"><?php echo ($info["level"]); ?></td>
                                    <td class="center">
                                    <?php if($info["state"] == 1): ?><a href="javascript:;" class="setGrowState" id="<?php echo ($info["id"]); ?>">显示</a>
                                    <?php else: ?> <a href="javascript:;" class="setGrowState" id="<?php echo ($info["id"]); ?>">不显示</a><?php endif; ?>
                                    </td>
                                    <td class="center">
                                        <a href="<?php echo U('Grow/addGroupdetails',array('id'=>$info['id']));?>">详情</a> &nbsp;
