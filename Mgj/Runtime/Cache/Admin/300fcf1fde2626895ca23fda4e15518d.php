    ...
    <div class="main-content">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo U('Comment/index');?>">学生列表</a>
                </li>
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <div style="padding: 10px;width:780px;margin:0 auto;margin-top:10px">
                        <table class="table table-bordered">
                            <tr class="">
                                <td class="center active" style="height: 82px;width:90px ">姓名</td>
                                <td class="center"><?php echo ($user["stu_name"]); ?></td>
                                <td class="center active" style="width:120px">学籍编号</td>
                                <td class="center" colspan="3"><?php echo ($user["id_number"]); ?></td>
                                <td class="center" rowspan="2" style="width: 130px;"></td>
                            </tr>
                            <tr>
                                <td class="center active" style="height: 82px;">出生年月</td>
                                <td class="center"></td>
                                <td class="center active">籍贯</td>
                                <td class="center"><?php echo ($user["stu_place"]); ?></td>
                                <td class="center active" style="width: 120px;">民族</td>
                                <td class="center"><?php echo ($user["family_name"]); ?></td>
                            </tr>
                        </table>
                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(!empty($vo["info"])): ?><table class="table table-bordered">
                                <tr class="active">
                                    <td rowspan="<?php echo ($vo["count"]); ?>" style="text-align:center;margin:0 auto;width:90px;line-height:28px;"><?php echo ($vo["title"]); ?></td>
                                    <?php if(is_array($vo["val"])): foreach($vo["val"] as $k=>$v): ?><td class="center"><?php echo ($v); ?></td><?php endforeach; endif; ?>
                                    <td class="center" style="width: 80px;">上报人</td>
                                    <td class="center" style="width: 80px;">审核人</td>
                                </tr>
                                <?php if(is_array($vo["info"])): foreach($vo["info"] as $k=>$v): ?><tr>
                                        <?php if(is_array($v)): foreach($v as $items=>$item): ?><td class="center"><?php echo ($item); ?></td><?php endforeach; endif; ?>
