    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <div class="nav-search" id="nav-search">
                <form class="form-search" action="<?php echo U('Admin/User/teacher');?>" method="get">
                    <span>
                        <label>
                    ...
                    <span class="input-icon">
                        <input type="text" placeholder="教师姓名" name="keyword" class="nav-search-input" id="nav-search-input" autocomplete="off" value="<?php echo ($keyword); ?>"/>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="" method="post">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
                                        ...
                                        <tr>
                                            ...
                                            <th class="center" class="hidden-480">所带课程</th>
                                        ...
                                        <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                                ...
                                                <td>
                                                    <?php if($v["state"] == 0 ): ?><input type="checkbox" class="userid" value="<?php echo ($v["rec_id"]); ?>" name="teacher_id" id="teacher_id1"/>
                                                        <?php else: ?> 已授权<?php endif; ?>
                                                </td>
                                                <td><?php echo ($v["tea_mobile"]); ?></td>
                                                <td><?php echo ($v["tea_name"]); ?></td>

                                                <td><?php echo ($v["tea_coursebh"]); ?></td>
                                                ...
                                                <td>
                                                    <div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                        <?php if($v["vidflag"] == 0): ?><button type="button" class="btn btn-success btn-xs teacher_vidf" name="<?php echo ($v["rec_id"]); ?>" id="teacherinfo" value="1">停用</button>
                                                            <?php else: ?> <button type="button" class="btn btn-success btn-xs teacher_vidf" name="<?php echo ($v["rec_id"]); ?>" id="teacherinfo" value="0">启用</button><?php endif; ?>

                                                        <a href="/index.php/User/edit_teacher/id/<?php echo ($v["rec_id"]); ?>.html" class="btn btn-xs btn-info">
                                                            <i class="icon-edit bigger-120"></i>
                                                        </a>

                                                        <a class="btn btn-xs btn-warning" name="tea_del" id="<?php echo ($v["rec_id"]); ?>"/>
                                ...
                                <input type="button" value="一键转为用户" class="btn btn-primary btn-xs" id="adduser_teacher"/>
                                <a href="addteacher.html"><input type="submit" class="btn btn-primary btn-xs"  value="添加教师"></a>

                                <form method="post" action="<?php echo U('Comment/excel_teacher');?>" enctype="multipart/form-data">
