...
<head>
    ...
    src: url('__PUBLIC__/css/iconfont.eot'); /* IE9*/
    src: url('__PUBLIC__/css/iconfont.eot?#iefix') format('embedded-opentype'), /* IE6-IE8 */
    url('__PUBLIC__/css/iconfont.woff') format('woff'), /* chrome、firefox */
    url('__PUBLIC__/css/iconfont.ttf') format('truetype'), /* chrome、firefox、opera、Safari, Android, iOS 4.2+*/
    url('__PUBLIC__/css/iconfont.svg#iconfont') format('svg'); /* iOS 4.1- */
}
        .iconfont{
...
<div class="system-message">
    <present name="message">
        <h1 class="true"><i class="iconfont">&#xe751;</i></h1>
